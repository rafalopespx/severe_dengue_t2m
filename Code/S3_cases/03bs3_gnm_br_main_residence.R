...
##saving
vroom_write(results_rr,   file = "Outputs/Brazil/results_rr_s3_br_residence.csv.xz")
vroom_write(results_lag,  file = "Outputs/Brazil/results_lag_s3_br_residence.csv.xz")
