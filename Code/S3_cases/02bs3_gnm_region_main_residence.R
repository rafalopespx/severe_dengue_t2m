...
for (i in 1:length(regions)){
  ...
  ## DLNM
  formula.gnm<- paste0('Cases', ' ~ cbtemp + cases_confirmed_7ma + ns(date, df = 7*10)')
...
##saving
vroom_write(results_rr,   file = "Outputs/Region/results_rr_s3_region_residence.csv.xz")
vroom_write(results_lag,  file = "Outputs/Region/results_lag_s3_region_residence.csv.xz")