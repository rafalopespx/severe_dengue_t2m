...
##saving
vroom_write(results_rr,   file = "Outputs/Region/results_rr_main_region_residence.csv.xz")
vroom_write(results_lag,  file = "Outputs/Region/results_lag_main_region_residence.csv.xz")