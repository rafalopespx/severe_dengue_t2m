...
##saving
vroom_write(results_rr,   file = "Outputs/State/results_rr_s2_state_residence.csv.xz")
vroom_write(results_lag,  file = "Outputs/State/results_lag_s2_state_residence.csv.xz")
