...
# Loading databases
## Lag and Overall
RRVal_lag_list <- vroom("Outputs/Brazil/results_lag_main_br_residence.csv.xz")
RR_overall_list <- vroom("Outputs/Brazil/results_rr_main_br_residence.csv.xz")
## Quantiles t2m
...
ggsave(plot = plot_overall, 
       filename = "Outputs/Plots/plot_overall_br_main.png", 
       width = 11, 
       height = 9, 
       dpi = 200)
...
ggsave(filename = "Outputs/Plots/percentil_effects_br_main.png", 
       plot = plot_percent, 
       width = 11, 
       height = 9, 
       dpi = 200)
...
ggsave(filename = "Outputs/Plots/figure_2_br_main_analysis.png", 
       plot = plot_figure1, 
       width = 11, 
       height = 9, 
       dpi = 200)
