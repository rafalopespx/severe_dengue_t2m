...
RR_overall_list <- vroom("Outputs/Brazil/results_rr_s1_br_residence.csv.xz")
## Quantiles t2m
...
ggsave(plot = plot_overall, 
       filename = "Outputs/Plots/plot_overall_br_s1.png", 
       width = 11, 
       height = 9, 
       dpi = 200)
...
ggsave(filename = "Outputs/Plots/percentil_effects_br_s1.png", 
       plot = plot_percent, 
       width = 11, 
       height = 9, 
       dpi = 200)
