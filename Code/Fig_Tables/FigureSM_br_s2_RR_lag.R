...
# Loading databases
## Lag and Overall
RRVal_lag_list <- vroom("Outputs/Brazil/results_lag_s2_br_residence.csv.xz")
RR_overall_list <- vroom("Outputs/Brazil/results_rr_s2_br_residence.csv.xz")
## Quantiles t2m
...
ggsave(plot = plot_overall, 
       filename = "Outputs/Plots/plot_overall_br_s2.png", 
       width = 11, 
       height = 9, 
       dpi = 200)
...
ggsave(filename = "Outputs/Plots/percentil_effects_br_s2.png", 
       plot = plot_percent, 
       width = 11, 
       height = 9, 
       dpi = 200)
...
ggsave(filename = "Outputs/Plots/figure_2_br_s2_analysis.png", 
       plot = plot_figureSM, 
       width = 16, 
       height = 9, 
       dpi = 200)

ggsave(filename = "~/Dropbox/Rafael_Paixao/Article_Dengue_hosp/IJHEH/Figures/Supplementary/figure_2_br_s2_analysis.png", 
       plot = plot_figureSM, 
       width = 16, 
       height = 9, 
       dpi = 200)
